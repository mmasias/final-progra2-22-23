...
public class HangmanLogic {
    ...
    public boolean isGameOver() {
        ...
        if (word.getMaxTries()< numberOfFaults){
    ...
    public boolean isWon() {
        ...
        String correctWord = hiddenWord().replaceAll("_", "");
        if (word.getLength() != correctWord.length()) {
            return false;
        }
        return true;
    }
    ...
    public String hiddenWord() {
        ...
        for (int i = 0; i < wordLength; i++) {
            char actualLetter = this.word.getWord().charAt(i);
            String letterTostring = "" + actualLetter;

            if (this.guessedLetters.contains(letterTostring)) {
                hiddenWord += actualLetter;
            } else {
                hiddenWord += "_";
            }
        }
