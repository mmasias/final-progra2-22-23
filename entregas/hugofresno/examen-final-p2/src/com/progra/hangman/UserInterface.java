...
public class UserInterface {
    ...
    private void loadData(String filename) {
        ...
        try {
            ...
            for (int i=0;i<data.size();i++){
                try {
                    words.add(wordParser.parse(data.get(i)));
        ...
        Usar el método com.progra.hangman.parsers.WordParser.parse para parsear las palabras
    ...
    public void start(String filename) {
        ...
        // cargamos el archivo y elegimos palabra al azar
        System.out.println("Cargamos datos. ");
        loadData(filename);
        currentWordIndex = randomIndex();
        gameOver=false;
        logic = new HangmanLogic(this.words.get(currentWordIndex));
        /*
