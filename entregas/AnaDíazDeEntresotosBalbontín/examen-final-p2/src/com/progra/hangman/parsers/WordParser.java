...
import com.progra.Exception.InvalidIdException;
...
public class WordParser implements Parser {
    ...
    public Word parse(String tokens) throws InvalidWordException {
         ...
         * Dependiendo del tipo crear la instancia de la clase Base.Word correspondiente, que puede ser de la clase WordShort, WordMedium o WordLong
         * */
